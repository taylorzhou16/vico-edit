...
| **最佳场景** | 首帧精确控制、场景一致 | 角色一致性、多人物 | **虚构片/短剧、智能切镜、MV** | ~~deprecated~~ |
...
**Veo3 已废弃（Deprecated）**：Veo3 不再作为推荐后端。时长固定（4/6/8s）、分辨率最高 720p，请使用 Kling/Kling-Omni/Seedance 替代。
...
| **~~Veo3~~** | ~~deprecated~~ | 已废弃，使用 Kling-3.0 替代 |
